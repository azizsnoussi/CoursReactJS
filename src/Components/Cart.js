          ...
          <MDBCardBody className="p-4">
            <MDBRow className="justify-content-between align-items-center">
              ...
              <MDBCol md="3" lg="4" xl="3">
                ...
                <h5>
                  <span className="text-muted"></span>{item.price} DT
                 
                </h5>
              </MDBCol>
              <Col> 
              <button style={{"textAlign" : "center",color:"red", border :" solid red 2px", width : "40px" , "borderRadius" : "20px"}}
            ...
            <Col> 
              <button style={{"textAlign" : "center",color:"green", border :" solid green 2px", width : "40px" , "borderRadius" : "20px"}}
              onClick={(e) => handleAdjustQuantity(item.id, parseInt(item.quantity+1))} 
              >+</button>
            </Col>
            <Col> 
            ...
            <Col> 
              <button style={{"textAlign" : "center",color:"red", border :" solid red 2px", width : "40px" , "borderRadius" : "5px"}}
